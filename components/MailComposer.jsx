        ...
        <Dialog>
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Send customized mails to <strong className="text-white">{recipients}</strong> selected recipient(s).
                    </DialogDescription>
                </DialogHeader>
                <div className="bg-zinc-900/80 border border-zinc-800 rounded-lg p-2.5 my-1 text-xs text-zinc-400 flex flex-wrap items-center gap-2">
                    <span className="font-semibold text-zinc-300">Supported Template Variables:</span>
                    <code className="px-1.5 py-0.5 bg-zinc-800 text-blue-400 rounded font-mono">#name</code>
                    <span className="text-zinc-500">(Applicant Name)</span>
                    <code className="px-1.5 py-0.5 bg-zinc-800 text-blue-400 rounded font-mono">#dept</code>
